...
??? note "Tutorial notes"
    ...
    - initiating a refugee claim
        - POE, CBSA. basis of claim is required in 15-45 days, and referred to RPD.
        - Inland Claim - Portal
        - eligibility, A101.
        - if you have an appeal right, you need to go to appeal before lodging a judicial review.
        - you will get a removal order during judicial review.
        - RPD rules 69/70, RAD 52/53, binding but discretion granted.
    - Group 1, **RPD Rules 49-52; RAD Rules 36-39**:
        ...
        - How would you make an application to the RPD or the RAD to ask for frequent breaks and shorter hearings? [in writing, to RPD and minister counsel]
        - In your answer, please cover RPD Rules 49-52; RAD Rules 36-39. Also, please focus your presentation on the following questions.
            - When should you make an application to the RPD or the RAD? [must be received by the division no later than 10 days before the date fixed for the hearing]
            - How do you make an application to the RPD or the RAD? [In writing.]
            - How are evidence included in applications to the RPD or the RAD? [any evidence that the party wants the Division to consider must be given in an **affidavit or statutory declaration** that accompanies the application. doctor letter is important, but medical certificate is not required as it's about changing date and time.]
    - Group 2, **RPD Rules 6-9, 65**:
        - Dave is a refugee claimant. He made a claim at the airport when he arrived in Canada. His claim was eligible to be referred to the IRB. He was given instructions that he must file his Basis of Claim form within the time limit. He came to your office and retained you to represent him for his claim. You noticed that he only has one day left to meet the deadline. When you asked him why he did not come to you earlier, he says that he does not speak English and he did not know that there was a deadline to submit the BOC form. Please review RPD Rules 6-9, 65 and incorporate these rules while you answer the following questions.
            ...
            - What are the deadlines to submit the BOC? (Answer: **IRPR ss 159.8(2) says 15 days. But there is a temporary policy in place extending the deadline to 45 days**, link [here](https://www.irb-cisr.gc.ca/en/legal-policy/procedures/Pages/rpd-pn-procedural-issues.aspx#s2){:target="\_blank"})
            - What should be included in the BOC?
            - What could happen if you do not submit your BOC in time? [R65, a special hearing held no later than 5 days after the boc is due.]
    ...
    - Group 3, **RPD Rules 10 and 44**:
        - Nadia's refugee hearing is one month away. She wants to present a witness at her hearing. She says that her mother witnessed Nadia being attacked by her persecutor. Her mother is elderly and very traumatized about the incident. She is anxious about testifying at the hearing. In your presentation, please cover RPD Rules 10 and 44. Please focus your presentation on the following questions.
            - What must you do to have the mother testify as a witness at Nadia's hearing? [Minister is not necessarily to be notified.]
            - What information should be given to the RPD prior to the hearing?
            - When must the notice be given?
            - In what order will the mother be questioned at the hearing? [R10, division first]
            - In what circumstances can the order of questioning be varied? [R10(5)]
    - Group 4, **RPD Rules 53-54**:
        ...
        - In your presentation, please cover RPD Rules **53-54**. Please focus your presentation on the following questions:
            - How do you ask for a change of hearing date? (written or oral) [R54, medical certificate.]
            ...
            - When will the new hearing date be? [R54(11), no later than 10 working days]
            - How do you ask for a change of location? [R53]
            - When should you make the application? [20 days before hearing.]
            - What factors will the Division consider in deciding the application?
    ...
    - Group 6, **RPD Rules 21-22; 24-25**:
        - Juan is a refugee claimant in Canada. He says his brother, Carlos, was also a refugee claimant in Canada. Juan and Carlos' claims are very similar as they both fear the same cartel in their country. Carlos had his refugee claim denied last year. Juan is worried that information from Carlos' hearing may be used in Juan's hearing. In your presentation, please cover RPD Rules 21-25. Please focus your presentation on the following questions:
            ...
            - If the Division wants to discuss this issue with counsel and Juan prior to the hearing date, what can the Division do? [R24(1)]
    - Group 7, **RAD Rules 2-7**:
        ...
        - In your presentation, please cover RAD Rules 2-7. Please refer to [IRB's guide for timelines](https://www.irb-cisr.gc.ca/en/filing-refugee-appeal/filing-a-refugee-appeal/pages/index.aspx){:target="\_blank"}.
            - What are the time limits to file an appeal at the RAD? [15 days]
            - Where can you find the notice of appeal?
            - What are the time limits to file the appeal record at the RAD? [45 days]
...
??? note "Refugee Protection Division and Refugee Appeal Division: The Statutory Framework"

    - [Sections 162 to 169](https://www.canlii.org/en/ca/laws/stat/sc-2001-c-27/222404/sc-2001-c-27.html#276250){:target="\_blank"} of the IRPA set out rules governing all 4 IRB divisions, including the RPD and the RAD.
    ...
    - RPD and RAD: Inquisitorial, not Adversarial
        - section 165 of the *IRPA* gives them the authority to summon witnesses and to require witnesses to give evidence, orally in or in writing, or to produce documents.
        - This provision confirms that proceedings before the RPD and RAD are meant to be **inquisitorial**, rather than **adversarial**. The member is to play an active role in questioning witnesses and determining how evidence is to be elicited during proceedings.
    - Proceedings
        - in principle, proceedings must be held in public
        - but proceedings before the **Refugee Protection Division** and the **Refugee Appeal Division** must be held in the absence of the public;
    - The Right to Counsel & Representation
        - subsection 167(1) of the IRPA provides a right to be represented by counsel before the IRB. Subsection 167(2) of the IRPA provides a right to have the division **designate a representative** for persons who are under 18 years of age or who are “unable to appreciate the nature of the proceedings.”
        - RPD rule 20 provides the duties of a designated representative include deciding whether to retain counsel, making decisions regarding the claim, assisting in gathering evidence, and filing an appeal with the RAD, if necessary.
        - RAD rule 23 includes many of the same requirements. The rule also states that if someone has been a designated representative for a claimant before the RPD, they are deemed to have been designated as a representative by the RAD on appeal.
    - Abandonment & Withdrawals
        - Section 168 is very important, as it governs abandonments and withdrawals.
        - RPD Rule 65 provides that before a claim can be declared abandoned, the Division must give the claimant the **opportunity to explain why it should not be**.
        - RAD Rule 68 is similar, although it only applies if a hearing has been scheduled.
        - It is very important to **avoid abandonment**. If a claim or appeal has been declared abandoned, under RPD Rule 62 or RAD rule 49, it may only be reopened if there was a failure of natural justice.

??? note "The Refugee Protection Division"

    - **Section 96** reproduces in its essentials the refugee definition from the 1951 Convention relating to the Status of Refugees. Persons falling within section 96 are referred to as “**Convention refugees**” in the IRPA.
    - Persons falling under **section 97** are referred to as “persons in need of protection” in the IRPA.
        - Note that “**persons in need of protection**” as defined in section 97 are distinct from “**protected persons**” who receive refugee protection under section 95. Being a person in need of protection is one ground for receiving refugee protection, hence for becoming a protected person. Not all protected persons, however, are persons in need of protection. Some of them may simply be Convention refugees.
    - Persons falling under **section 98** are expressly **excluded** from the definitions in sections 96 and 97 and hence cannot receive refugee protection.
    - subsection **107(1)** states that the RPD shall accept a claim for refugee protection if the claimant is either a Convention refugee (i.e., if they fall within section 96) or a person in need of protection (i.e., if they fall within section 97). Otherwise, the RPD shall reject the claim.
...
??? note "The Refugee Appeal Division"
    ...
    - The provisions governing the RAD are found in **sections 110-111 and 171-171.1** of the IRPA.
    - The RAD has been designed to be a primarily **paper-based appeal** of the RPD’s decision, with very limited powers to either receive new evidence or to hold oral hearings. It reviews RPD decisions on a **correctness** standard (see *Canada (Citizenship and Immigration) v Huruglica*, [2016 FCA 93](http://canlii.ca/t/gp2gp){:target="\_blank"})
    - Seven Grounds For **Denying a Right of Appeal**
        ...
        - **Designated Countries of Origin:** Paragraph **110(2)(d.1)** denied appeals from a decision concerning foreign nationals who were citizens of countries designated under section 109.1 of the IRPA. However, paragraph 110(2)(d.1) was declared unconstitutionally discriminatory under section 15 of the Charter in *Y.Z. v Canada (Citizenship and Immigration)*, [2015 FC 892](http://canlii.ca/t/gkcps){:target="\_blank"}. The *Y.Z.* decision was not appealed. Therefore, **paragraph 110(2)(d.1) is of no force or effect**.
        - ==**Cessation:**== **110(2)(e)** a decision of the Refugee Protection Division allowing or rejecting an application by the Minister for a determination that refugee protection has ceased;
        - ==**Vacation of Refugee Protection:**== paragraph **110(2)(f)** of the IRPA bars appeals from decisions of the RPD allowing or rejecting an application under section 109 by the Minister to vacate a decision to allow a claim for refugee protection.
    - Under rule 3 of the **RAD Rules**, a **perfected record** must include:
        - The notice of decision and written reasons of the RPD.
        - All or part of the transcript of the RPD decision, if the appellant wants to use it in the appeal.
        - Any documents that the RPD refused to accept as evidence if you want to use those documents in support of your appeal.
        - A written statement that states whether you are submitting new evidence that that was not submitted to the RPD and whether you are requesting an oral hearing on the basis of that evidence.
        - Legal authorities that support your arguments on appeal.
        - A memorandum of argument.
    - subsection 110(4): On appeal, the person who is the subject of the appeal may present only **evidence that arose after the rejection of their claim or that was not reasonably available**, or that the person could not reasonably have been expected in the circumstances to have presented, at the time of the rejection.
    - The Court of Appeal In *Canada (Citizenship and Immigration) v Singh*, [2016 FCA 96](http://canlii.ca/t/gp31b){:target="\_blank"} at paragraph 34 stated that subsection 110(4) only allows for the submission of evidence
        - that arose after the rejection of the claim;
    ...
    - subsection 110(5) states that the restrictions on new evidence in subsection 110(4) do not apply when a claimant is responding to evidence submitted by the Minister.
    - Subsection 110(6) of the IRPA significantly limits the availability of oral hearings at the RAD. the RAD may only hold **oral hearings to resolve determinative issues of credibility arising out of evidence** that was not part of the RPD record. Even when there is new evidence that meets those criteria, the power to hold a hearing or not is still discretionary (on this point, see *Oluwakemi v. Canada (Citizenship and Immigration)*, [2016 FC 973](http://canlii.ca/t/gtzw0){:target="\_blank"} at paragraph 7).
    - Referrals:
        - A111(2) The Refugee Appeal Division may make the referral described in paragraph (1)(c) only if it is of the opinion that
...
??? note "Making a Claim in Canada"
    ...
    1. If an officer has not made a decision on eligibility, the Refugee Protection Division can determine a claimant's eligibility on its own and proceed to hear the claim.
        - [ ] True
        - [x] False
        > IRPA, s 100(3) states that the "Refugee Protection Division may **not consider a claim until it is referred by the officer**."

    2. Which of the following claimant(s) may be **ineligible** to be referred to the Refugee Protection Division? Choose all that apply.
        - [x] A claimant who has **abandoned** a previous claim
        - [x] A claimant who has refugee protection **conferred** under the IRPA
        - [ ] A claimant who has a family member with serious medical conditions
        - [ ] A claimant who has made a claim for refugee protection to another country after making a claim for refugee protection in Canada
    ...
    4. According to the Refugee Protection Division Rules, when notifying the claimant about the hearing, which of the following must the officer include in the written notice?
        ...
        - [ ] Date, time, location, and name of attending officer for the hearing
        - [ ] Date, time, location, and the right to request an interpreter for the hearing
    ...
    6. Under which of the following circumstance(s) can a claim be **suspended**? Choose all that apply.
        ...
        - [ ] The officer is waiting for a court decision with respect to a punishable offense by a maximum term of imprisonment of at least 6 months.
        - [x] The claimant has a matter referred to the **Immigration Division** for a determination that they are inadmissible on grounds of **organized criminality**.
        - [ ] The claimant has requested their claim to be examined by another officer.

    7. Which of the following claimant(s) may be ineligible to be referred to the Refugee Protection Division? Click on all that apply.
        - [x] A claimant who has **withdrawn** a previous claim
        - [x] A claimant who is a **Convention** refugee in another country and can be returned to that country
        - [ ] A claimant who has a medical condition in need of urgent treatment
        - [x] A claimant who has a **rejected** claim from the RPD

    8. During the application process at a port of entry, the claimant can request their counsel to represent them at interview(s), including by questioning the claimant and objecting to lines of questions from an officer.
        - [ ] True
        - [x] False
        > Although counsel can attend interviews, they are **not allowed to interfere** with the interview process.

    9. Five years ago, Peter was convicted of Arson by negligence (see section 436 of the Criminal Code) and sentenced to 1 year in prison. He has been determined to be inadmissible. He nonetheless wishes to make a claim for refugee protection to avoid deportation to his home country, where he says he faces persecution. Is his claim eligible?
        - [x] Yes
        - [ ] No
    ...
    10. Parminder's claim has been rejected by the Refugee Protection Division. He has launched an appeal of that decision to the Refugee Appeal Division. A CBSA officer subsequently learns that the referral was in error, after confirming pursuant to an information-sharing agreement that Parminder made a claim for refugee protection in Australia. What can the officer do?
        ...
        - [ ] The officer may terminate the claim pursuant to IRPA, s 104(1)(c)
        - [ ] The officer may terminate the claim pursuant to IRPA, s 104(1)(d)
        > See IRPA, s 104(1)(a.1). That provision allows an officer to give notice to the IRB that a claimant has made a claim for r**efugee protection in another country** which has been confirmed pursuant to an information-sharing agreement. The effect of such a notice is to **terminate proceedings** before either the RPD or the RAD, pursuant to IRPA, s 104(2)(a.1).

    11. Five years ago, Bob was convicted of Arson - disregard for human life (see section 433 of the Criminal Code) and sentenced to one year in prison. He has been determined to be inadmissible on grounds of serious criminality. He nonetheless wishes to make a claim for refugee protection to avoid deportation to his home country, where he says he faces persecution. Is his claim eligible?
        - [ ] Yes
        - [x] No
    ...
    12. Twenty years ago, Mikhail's parents brought him to Canada and made a claim for refugee protection. Mikhail was only four at the time. The family's claim was subsequently determined to be abandoned, and they returned to their country of origin. Mikhail is now back in Canada and has made a claim for refugee protection on his own behalf. Unfortunately, his claim is ineligible.
        - [x] True
        - [ ] False
        > IRPA, s 101(1)(c) states that a claim is ineligible if a prior claim by the claimant was determined to be abandoned. Because Mikhail's prior claim was determined to be abandoned, his new claim is not eligible **even though he was a child** and his parents were acting on his behalf 20 years ago.

    13. In assessing the eligibility of a claim for refugee protection, the officer bears the burden of proof to establish ineligibility based on the evidence given.
        - [ ] True
        - [x] False
        > According to **s 100(1.1)** of the IPRA, the burden of proving that a claim is eligible rests on the **claimant**.

    14. Which of the following is not a method in applying for refugee protection under section 95 of the IRPA?
        - [ ] Applying for a visa from abroad
        - [ ] Making a claim for "refugee protection"
        - [x] Making a claim for "humanitarian and compassionate grounds"
        - [ ] Making a claim for "protection"

    15. Jolene's claim has been referred to the Refugee Protection Division. Subsequently, a CBSA officer learns that Jolene was found guilty of murder in her home country 10 years ago. Which of the following best describes the officer's possible course(s) of action?
        - [ ] The officer cannot do anything about Jolene's claim. Once a claimant has been referred to the RPD, the eligibility determination is deemed final.
