...
??? note "Persuasive Submissions"

    - Generally, you can think of oral submissions as having four phases or parts:
        - A brief opening statement identifying what you want for your client – the issue and the conclusion
        - The principal elements of your argument (generally, the conclusions that you want the decision maker to reach), which are supported by...
        - References to relevant legal authority (legislation and binding case law) as well as government policy, all of which are explicitly applied to...
        - The relevant facts of your client’s case (this may include a review of results at prior detention review hearings)
    - your submissions should start by addressing the **section 58** grounds that have been used to justify your client’s detention. Typically, you will argue that there are **no such grounds to justify detention or that any grounds are at the lower end** of the spectrum and then show why this is the case using facts and law.  You should address the factors in **ss. 245-257** and applicable sections of **Guideline 2** when addressing the grounds as well as any other relevant factors.
    - Emphasize the most important facts in your favour: for example, facts might include a significant change in circumstances from the last hearing, or you might point to errors made in a prior hearing that must be rectified. You will also need to make sure that you address the Minister’s position and any evidence that they have provided to support it.
    - After you present your arguments on the ground for detention, you need to set out how, if the Member finds that a ground for detention is made out, the **s. 248 factors** favour release. Remember that providing **an alternative to detention is just one part of the s. 248** factors that must be canvassed.
    - Finally, as you would do in a written submission structured using CREAC, wrap up your oral submissions by briefly reiterating the legal conclusion you want the decision maker to reach. For example: “*for these reasons, we request that the PC be released as his flight risk falls at the low end of the spectrum and the s. 248 factors favour his release.*”
