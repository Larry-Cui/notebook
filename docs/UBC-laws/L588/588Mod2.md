...
!!! info "***Butterfield (Re)***, [2017 LSBC 2 (CanLII)](https://canlii.ca/t/gx2bv){:target=" \_blank"}"
    ...
    > (***Law Society of BC v. Rai***, [2011 LSBC 2 (CanLII)](https://www.canlii.org/en/bc/lsbc/doc/2011/2011lsbc2/2011lsbc2.html){:target=" \_blank"}, 2011 LSBC 02, paras. 6 – 8)

    [37] A 2015 hearing panel characterized the proceeding as follows: **The hearing panel either must accept the admission and the proposed disciplinary action or reject it and send it back to the Discipline Committee.** (***Law Society of BC v. Penty***, [2015 LSBC 51](https://www.canlii.org/en/bc/lsbc/doc/2015/2015lsbc51/2015lsbc51.html){:target=" \_blank"}, para. 84)
...
!!! danger "Quiz"
    ...
    1. Which of the following is not defined in the *Legal Profession Act*?
        - [ ] Conduct unbecoming the profession
        - [ ] Lawyer
        - [ ] Practice of law
        - [x] Interest of the public

    2. To determine the definition of “good character” for you your province or territory, you would examine the relevant provincial or territorial statute. 
        - [ ] True
        - [x] False

    3. According to the **Immigration & Refugee Board** website, only the following can represent someone for a fee in an IRB hearing:
        ...
        - [x] A B.C. paralegal in good standing
        - [ ] They can all represent her in B.C. for a fee

    4. Unless otherwise specified, any financial obligation undertaken by a lawyer on behalf of their client is a personal one.
        - [x] True
        - [ ] False

    5. In which of the following situations would it be most appropriate for you to **delegate work to a non-lawyer**?
        - [ ] Delegating specialized immigration work to a real estate paralegal
        - [x] Delegating a general small claims court appearance to an articling student
    ...
    6. Historically, law schools in Canada have had a large amount of control over the curriculum of legal education.  In 2009, the **Federation of Law Societies of Canada** recommended a more uniform basis for legal education across Canada.  According to the readings, what prompted this change?
        ...
        - [x] The growing number of persons with foreign law degrees seeking admission to practise law across Canada.
        - [ ] None of the above – there has been no movement towards more uniform legal education in Canada

    7. According to the B.C. **Code** in Chapter 6, only a “licensed paralegal” may be employed by a lawyer as a “paralegal” in B.C. 
        - [ ] True
        - [x] False

    8. In Canada, its fair to say that lawyers have established a state-sanctioned monopoly in the market for legal services.
        - [x] True
        - [ ] False

    9. Which of the following examples would be **most likely** to generate disciplinary action against a lawyer?
        - [x] Receiving several letters from the Law Society of B.C. in a 1 year period demanding a response and not responding to any of them
